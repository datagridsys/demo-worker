...
namespace Worker
{
    ...
    {
        private static bool signalReceived = false;

        public static int Main(string[] args)
        {
            Console.CancelKeyPress += new ConsoleCancelEventHandler(HndlEvent);
            try
            {
        ...
        private static void HndlEvent(object sender, ConsoleCancelEventArgs e)
        {
            e.Cancel = true; // Ignore signal
            signalReceived = true;
        }
